...
desaturated_image = ((minimum + maximum) / 2).astype(np.uint8)
...
def reduce_grayscale_shades(image, num_shades):
    ...
    # This applies the weighted average method
    ...
    for i in range(num_shades):
        ...
        # Set the new grayscale value to the middle of the interval
        new_value = (lower_bound + upper_bound - 1) // 2

        # Assign the new value to all the intensities within the interval
        new_gray_values[lower_bound:upper_bound] = new_value
